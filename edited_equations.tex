...
Therefore, when the co-ordinate axes have the supposed directions, which are called the \textit{principal axes of stress}, the rectangular components of the traction across any surface $(\alpha,\beta,\gamma)$ are by (\ref{379})
...
\eqs d\sigma = -\eta_{S(\ref{1})}\, dt -\Gamma_{2(\ref{1})} \, d\mu_2, - \Gamma_{3(\ref{1})} \, d\mu_3 - \text{ etc.}, \label{514}\eqe 
...
\eqs d\sigma= -\left(\eta_{S(\ref{1})} - \frac{\Gamma_{2(\ref{1})}}{\gamma_2}\eta_{V2}  - \frac{\Gamma_{3(\ref{1})}}{\gamma_3}\eta_{V3}- \text{ etc.}\right)\, dt \\
-\frac{\Gamma_{2(\ref{1})}}{\gamma_2} \, dp_2 -\frac{\Gamma_{3(\ref{1})}}{\gamma_3} \, dp_3- \text{ etc.}  \label{585} \eqe
...
\eqs \frac{\eta_{S(\ref{1})}}{\gamma'(\eta_M''-\eta_M')},\label{589} \eqe
and the diminution of the volume of vapor
\eqs \frac{\eta_{S(\ref{1})}}{\gamma''(\eta_M''-\eta_M')} \label{590} \eqe
Hence, for the work done (per unit of surface formed) by the external bodies which maintain the pressure, we shall have
\eqs W =\frac{p\, \eta_{S(\ref{1})}}{(\eta_M''-\eta_M')} \left(\frac{1}{\gamma''}-\frac{1}{\gamma}\right), \label{591} \eqe
...
When the variations of temperature and of the quantities $M_1$, $M_2$, \text{ etc.} \{see (\ref{617})\} involved in the changes considered are so small that they may be neglected, the condition of stability takes a very simple form, as we have already seen to be the case with respect to a system uninfluenced by gravity. (See page 251.)
...
\eqs \frac{ds}{s}= -\frac{ d(\lambda \gamma_1)}{\lambda \gamma_1}= -\frac{ d(\lambda \gamma_2+2\Gamma_{2(\ref{1})})}{\lambda \gamma_2+2\Gamma_{2(\ref{1})}}.   \label{644}\eqe
Hence we obtain
\begin{align*}
...
\eqs 2\gamma_1 \Gamma_{2(\ref{1})} \frac{ds}{s} = - \lambda \gamma_1 \, d\gamma_2 + \lambda \gamma_2 \, d\gamma_1- 2\gamma_1 \, d\Gamma_{2(\ref{1})}.  \label{645}\eqe
...
and           \eqs     2\Gamma_{2(\ref{1})}= - \lambda \gamma_1 \, dr- 2 \, d\Gamma_{2(\ref{1})}.  \label{648}\eqe
...
This will give
\eqs 4\Gamma_{2(\ref{1})}^2 \, d\mu_2= E(\lambda \gamma_1 dr + 2 d\Gamma_{2(\ref{1})}),  \label{649}\eqe
or
\eqs \frac{4\Gamma_{2(\ref{1})}^2}{E}= \lambda \gamma_1 \frac{dr}{d\mu_2} + 2 \frac{d\Gamma_{2(\ref{1})}}{d\mu_2}, \label{650}\eqe
...
and
\eqs   E= 4\Gamma_{2(\ref{1})}^2  \left(\frac{d\mu_2}{dG_2} \right)_{G_1}    \label{655} \eqe 
...
\eqs \sigma = \epsilon_{S(\ref{1})}-t \eta_{S(\ref{1})} - \mu_2 \Gamma_{2(\ref{1})} - \mu_3 \Gamma_{3(\ref{1})}- \text{ etc.},  \label{659} \eqe
...
\eqs d\epsilon_{S(\ref{1})} = t\, d\eta_{S(\ref{1})} + \mu_2 \, d\Gamma_{2(\ref{1})} + \mu_3\, d\Gamma_{3(\ref{1})} + \text{ etc.}, \label{674} \eqe
since this relation is implied in the definition of the quantities involved. From this and (\ref{659}) we obtain
\eqs d\sigma = -\eta_{S(\ref{1})}\, dt - \Gamma_{2(\ref{1})}\, d \mu_2 - \Gamma_{3(\ref{1})} \, d\mu_3 - \text{ etc.},  \label{675} \eqe
...
% Sense in which formula (\ref{52}) may be regarded as expressing the condition'
% sought, -    -    -    -    -    -    -   -    -    -    -    -   -        75
% Condition (\ref{53}) is always sufficient for equilibrium, but not always necessary, -  77 A mass in which this condition is not satisfied, is at least practically unstable,  79 (This condition is farther discussed under the head of Stability. See p. 100.)
